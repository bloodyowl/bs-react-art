...
module Transform = {
  ...
  external rotate : deg::int => x::int => y::int => t =
    "" [@@bs.send.pipe : t];
  external rotateTo : deg::int => x::int => y::int => t =
    "" [@@bs.send.pipe : t];
  external resizeTo : width::int => height::int => t = "" [@@bs.send.pipe : t];
  external jsPoint : x::int => y::int => jsPoint =
    "point" [@@bs.send.pipe : t];
  external jsInversePoint : x::int => y::int => jsPoint =
    "inversePoint" [@@bs.send.pipe : t];
...
module LinearGradient = {
  ...
  external makeFromJsStops :
    stops::Js.t {.} => x1::int => y1::int => x2::int => y2::int => t =
    "LinearGradient" [@@bs.module "react-art"] [@@bs.new];
};
...
external surface : ReasonReact.reactClass =
  "Surface" [@@bs.module "react-art"];
...
module Group = {
  let make
      ...
      scaleX::(scaleX: option int)=?
      scaleY::(scaleY: option int)=?
      scale::(scale: option int)=?
      x::(x: option int)=?
      y::(y: option int)=?
...
external shaped : ReasonReact.reactClass = "Shape" [@@bs.module "react-art"];
